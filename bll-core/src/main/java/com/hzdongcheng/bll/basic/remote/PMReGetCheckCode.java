...
import com.hzdongcheng.bll.basic.dto.InParamPMReGetCheckCode;
...
public class PMReGetCheckCode extends AbstractRemoteBusiness {
	@Override
	...
	protected String handleBusiness(IRequest request, IResponder responder,
		...
		InParamPMReGetCheckCode inParam = (InParamPMReGetCheckCode) request;
		String result = "";
