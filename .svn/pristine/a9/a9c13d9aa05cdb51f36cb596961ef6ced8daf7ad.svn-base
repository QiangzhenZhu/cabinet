...
public class TimerUtils {
    ...
    class TimeCount extends CountDownTimer {
        ...
        public void onFinish() {//计时完毕时触发
            ...
            if (context!=null&&ViewModelProviders.of((FragmentActivity) context).get(MainViewmodel.class)
                    .mainModel.getCurrentFragment()!=null &&!ViewModelProviders.of((FragmentActivity) context).get(MainViewmodel.class)
                    .mainModel.getCurrentFragment().getValue().equals(NavigateHomeFragment.class))
                ViewModelProviders.of((FragmentActivity) context).get(MainViewmodel.class).mainModel.getCurrentFragment().setValue(NavigateHomeFragment.class);
        }
