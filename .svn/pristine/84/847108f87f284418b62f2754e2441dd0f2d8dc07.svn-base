...
import com.hzdongcheng.bll.basic.dto.InParamPMPostmanUnBindCard;
...
public class PMPostmanUnBindCard extends AbstractRemoteBusiness {
	@Override
	...
	protected String handleBusiness(IRequest request, IResponder responder,
		...
		InParamPMPostmanUnBindCard inParam = (InParamPMPostmanUnBindCard) request;
		String result = "";
