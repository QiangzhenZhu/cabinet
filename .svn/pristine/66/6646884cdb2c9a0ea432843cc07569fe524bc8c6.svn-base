...
public class PATerminalCtrlParamDAO{
 private static final Logger log = Logger.getLogger(PATerminalCtrlParam.class);
 private static final String TABLE_NAME = "PATerminalCtrlParam";
 private static final Class CLASS_TYPE = PATerminalCtrlParam.class;

 public PATerminalCtrlParamDAO(){}


	public int insert(SQLiteDatabase database,PATerminalCtrlParam obj) throws DcdzSystemException{
	...
	public PATerminalCtrlParam find(SQLiteDatabase database, JDBCFieldArray whereCols) throws DcdzSystemException{
		List<PATerminalCtrlParam> listResult = DbUtils.executeQuery(database,TABLE_NAME,whereCols,CLASS_TYPE);
		if(listResult == null || listResult.size()==0)
			throw new DcdzSystemException(DBErrorCode.ERR_DB_NORECORD);

		PATerminalCtrlParam result = listResult.get(0);
		return result;
	}


	public List<PATerminalCtrlParam> executeQuery(SQLiteDatabase database, JDBCFieldArray whereCols) throws DcdzSystemException{
		return DbUtils.executeQuery(database,TABLE_NAME,whereCols,CLASS_TYPE);
	}


	public List<PATerminalCtrlParam> executeQuery(SQLiteDatabase database, JDBCFieldArray whereCols,String orderBy) throws DcdzSystemException{
		return DbUtils.executeQuery(database,TABLE_NAME,whereCols,CLASS_TYPE,orderBy);
	}


	public List<PATerminalCtrlParam> executeQuery(SQLiteDatabase database, JDBCFieldArray whereCols,String orderBy,int recordBegin,int recordNum) throws DcdzSystemException{
