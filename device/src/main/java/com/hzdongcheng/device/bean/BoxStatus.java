...
public class BoxStatus {
	...
	public BoxStatus() {
		setGoodsStatus(MasterStatus.UNKNOWN_STATUS);
		setOpenStatus(MasterStatus.UNKNOWN_STATUS);
		setHeatStatus(MasterStatus.UNKNOWN_STATUS);
		setLedLanternStatus(MasterStatus.UNKNOWN_STATUS);
		setRedLanternStatus(MasterStatus.UNKNOWN_STATUS);
		setDisinfectStatus(MasterStatus.UNKNOWN_STATUS);
